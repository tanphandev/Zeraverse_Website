    ...
    <div className="font-nunito text-main-whileColor border-[5px] border-main-pink-f4 rounded-[20px] bg-main-grayColor-80 py-[24px] px-[28px] mb-[40px]">
      ...
      <div className="text-base font-bold font-nunito text-justify">
        ...
        <p>
          ...
          players, share your achievements, and showing your results in a Hall
          of Fame. We're constantly innovating and adding new features to make
          your gaming experience even more enjoyable.
        </p>
        <br />
        <p>
          At our core, we're gamers just like you, and we're committed to
          bringing you the best possible gaming experience. So come join us, and
          let's game together!
        </p>
      </div>
