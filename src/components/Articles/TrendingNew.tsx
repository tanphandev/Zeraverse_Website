  ...
  return (
    <div>
      ...
      <div className="overflow-x-scroll no-scrollbar w-full">
        <div className="grid grid-cols-2 gap-4 mb-[22px] w-full min-w-[976px]">
          {list2Item?.map((item, index) => (
            <div
              ...
              key={index}
              className="w-full flex items-center border border-main-pink-be rounded-[10px] bg-main-blackColor cursor-pointer"
            >
              <CustomImage
